...
The algorithm was validated on a NAO humanoid robot and used a learned leg odometry motion model.
...
This provided a faster localization with respect to the known global octomap \cite{hornung2013octomap}, . 
