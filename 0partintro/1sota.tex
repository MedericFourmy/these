...
and low latency (<1 ms) estimates owing to the inherent instability their dynamics. Moreover, they interact with the environment through 
...
come from the lower quality of the sensor (a low-cost MEMS IMU gyroscope exhibits much more noise than a high-end fiber-optic gyroscope) or from the process needed to obtain the
...
modified the kinematic factor formulation, taking into account uncertainty induced by contact switches. At the Dynamic Robot Systems Group at Oxford, Wisth proposed in 
