...
"Indeed, most today’s approaches to reconstruct orientations with
...
the platform \cite{ayusawa2008identification, bonnet2019overview} \improvement[inline]{mass distribution calibration refs?}. This problem was closely scrutinized in the biomechanics literature where mass distributions of human subjects coupled with 
...
The computation of this point only actually requires the contact normal force and horizontal moments, which is unsurprisingly \improvement[inline]{find a synonym} the kind of
