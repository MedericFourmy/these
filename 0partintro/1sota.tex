...
\cite{johnson2015team} teams, that both were using the Atlas humanoid robot (picture in \figRef{fig:robots}), explain that they implemented tightly-coupled nonlinear estimators for the 
...
\subsection{Mitigation of kinematics model inaccuracies}
% BAD
...
From here, the reader is invited read the main scientific statement of the thesis in \secRef{sec:thesis_organization}, as we hope the presentation of the state of the art cast a new light on this section. 
