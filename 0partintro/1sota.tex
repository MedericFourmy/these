...
\cite{stasse2017talos} (\figRef{fig:robots}) by modeling it as a passive joint with a damped-spring model.
...
transformation filtering. Classification of the terrain, based on local gradient thresholds, is used implement dynamical manoeuvers in a cluttered environment
...
scan alignments by minimizing a cost function over a trajectory of 2D poses constrained by LIDAR scans and wheel odometry.
 Many ad hoc efficient solvers such as \cite{grisetti2011g2o, kaess2012isam2, ila2017slam++, ceres-solver} have been developed 
