...
We think that this can be attained by different means. First, by a flexible software architecture
...
found in \url{www.iri.upc.edu/wolf}}, that we have used and contributed to during the preparation of this thesis). Second, by a generalization of mathematical
 ...
 naturally leading to an estimator that finds the maximum of the posterior probability distribution over the states.
