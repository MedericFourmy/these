...
on the special treatment variables belonging to manifolds and give a brief introduction to Lie theory, which is used extensively in chapter 6.

\textbf{Chapter 4} describes measurement models used in the object-level visual-inertial systems that we built. 
...
Throughout this work, we contributed to different parts of the WOLF state estimation framework \cite{sola2021wolf} which was submitted to RAL journal this year.
