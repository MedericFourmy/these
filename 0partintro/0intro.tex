...
A digression through a biological example can give some intuitions to grasp the complexity of the problem. For instance, the simple task of picking up a box
...
integrated \cite{miller2005perceptual, sugihara2006integration}: watching a speaker's mouth changes our perception of its speech. 
...
\cite{aw1996three} and is constantly being recalibrated throughout our life \cite{miles1981plasticity}. Notice that this performance is likely only made possible 
...
in the head has an evolutionary advantage that can be explained by several reasons \cite{bailly2018should}: stimuli from sensory organs whose spatial relation is fixed
are easier to process; shorter pathways between senses and the brain increases the acceptable bandwidth of information; the independence of the head helps to stabilize the sensory
inputs as well as it enables active exploration strategies. Despite these facts, except for humanoid robots, few systems come equipped with a truly multisensory head 
