...
for the experiments on the quadruped robot Solo \cite{grimminger2020open} as shown in Fig. \figRef{figfig:solo_and_stairs}. 
...
to the result (Fig. \figRef{figfig:traj_circular}). But we can notice that the MTE is also reduced (Table \figRef{figtable:tless}). Indeed, the motion model is more precise thanks 
