...
\begin{figure}%[!ht]
  ...
  \caption{Experimental setup: a Realsense D435i is mounted on the Solo robot which localizes itself \wrt stairs. A motion capture system provides ground 
...
for the experiments on the quadruped robot Solo \cite{grimminger2020open} as shown in Fig. \ref{fig:solo_and_stairs}. 
