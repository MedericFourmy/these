...
it had not been demonstrated on a humanoid robot, to the best of our knowledge. We have been able to obtain an accurate estimation of the humanoid robot \HRP{2} in a 3D terrain.
...
robot walks along a loop in the experimental room. This experimentally validates the relevance of fusing these two information sources for localizing a legged robot. In particular, the filter provides a full consistency, on the opposite to loosely-coupled 
