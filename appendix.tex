...
We detail here how the delta formulas of equation \ref{eq:IMUPreintim} can be derived from \ref{eq:IMUIntim}.
...
The position delta requires more calculations. First, inject equation \ref{eq:IMUDeltav} in the position equation of \ref{eq:IMUIntim} then rearrange and reorder the terms.
