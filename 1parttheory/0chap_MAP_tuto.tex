...
property, define the so-called Lie group. Structural elements especially useful are the existence of an identity element (that can be thought of as the origin of the manifold), the existence of inverse for each element, the adjoint linear map, and the possibility to interpolate between elements.
