...
are described as residuals weighted by their respective covariance matrices, representing the confidence we have on the sensor measurements. 
...
formulating new, efficient, and generalizable measurement models is equally important. The next chapters each concentrate on a different sensor modality:
