...
% \begin{equation}
%     \begin{split}
%     \bfDelta \Rot{}{ij} &\triangleq  \Rot{}{}^{i,T} \Rot{}{}^{j} =  \prod_{k=i}^{j} \Exp((\angvelm{}{}^k - \bias_{\angvel{}{}^k} - \noise_{\angvel{}{}^k})dt) \\
%     \bfDelta \vel{}{ij} &\triangleq \Rot{}{}^{i,T} (\vel{}{j} - \vel{}{i} - g \Delta t_{ij}) 
%     = \prod_{k=i}^{j} \bfDelta \Rot{}{ik} \Exp((\accm{}{}^k - \bias_{\acc{}{}}^k - \noise_{\acc{}{}}^k)dt)  \\
%     \bfDelta \posi{}{ij} &\triangleq \Rot{}{}^{i,T}(\posi{}{}^j - \posi{}{}^i - \vel{}{}^i \Delta t_{ij} - \frac{1}{2} \grav \Delta t_{ij}^2) 
%     = \sum_{k=i}^{j} \Big[\bfDelta \vel{}{ik}dt +  \frac{1}{2} \bfDelta \Rot{}{ik} (\accm{}{}^k - \bias_{\acc{}{}}^k - \noise_{\acc{}{}}^k)dt^2 \Big]
%     \end{split}
