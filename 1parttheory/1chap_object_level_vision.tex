...
Depending on the nature of the problem, we can fix some of the variables of the residual. In \tabRef{tab:res_var_fix}, various estimation problems are modelled depending on which variable is fixed.
