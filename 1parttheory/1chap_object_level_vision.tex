...
% Another interpretation of these derivations is the Laplace approximation presented in \chpRef{chp:MAP_covariance}. 
...
For the position uncertainty (\figRef{fig:apriltag_cov_P}), the shape of the covariance is easily interpretab: the uncertainty is the highest along the camera-tag axis.
