...
residual definition. Instead, we resort to the generalized pre-integration algorithm that we developed in \secRef{sec:sec:general-preint}.
...
This section follows the same structure and logic as the two IMU pre-integration algorithm described in \secRef{sec:sec:imu_preint_composite} and \secRef{sec:sec:imu_preint_compact} since
...
should apply to the centroidal states in our case. This is confirmed by experimental results presented in \secRef{sec:chp:centroidal_estimation}.
