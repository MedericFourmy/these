...
We perform pre-integration incrementally following a few steps. 
...
Being computed in the same manner, the definitions of the $\boxminus$ and $\boxplus$ operators is a trivial manner of composing the matrix deltas from \eqRef{equ:boxminus-forster}, having
%
\begin{align}
