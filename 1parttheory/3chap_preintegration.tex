...
First, by observing \eqRef{eq:IMUIntij} we can define a motion error, as follows. We define the motion increments or "deltas":
...
The dependency on the bias variable in \eqRef{eq:imu_delta} still enforces the repeated reintegration of the measurements buffer to get $\bfDelta_{im}$. 
