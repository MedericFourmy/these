...
Pre-integration refers to the integration of high rate proprioceptive sensory data efficiently in the context of factor graphs. 
The IMU pre-integration theory can be generalized to many other proprioceotive sensors as shown in \cite{atchuthan-18-thesis,deray-19-selfcalib,fourmy2021contact}.
...
context of factor graph legged robots state estimation to derive new leg odometry factors \cite{hartley2018legged, wisth2019robust, wisth2020pre-integrated}.
